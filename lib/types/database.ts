...
export interface Card { id:string; user_id:string; account_id:string; limite:number; dia_fechamento:number|null; dia_vencimento:number|null; melhor_dia_compra:number|null; }
...
export interface Activity { id:string; household_id:string; nome:string; recorrencia:Recorrencia; dias_semana:number[]|null; responsavel:string|null; criado_por:string|null; ativo:boolean; }
export interface ActivityCompletion { id:string; activity_id:string; household_id:string; data:string; feito_por:string|null; }
